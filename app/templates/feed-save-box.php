<div class="postbox">
    ...
    <div class="misc-pub-section">
			<h3 class="version">Version <?php _e(SENDERLAW_ELA_RSS_PI_VERSION); ?></h3>
			<ul>
				<li>
        ...
        <li>    
          ...
          <div id="user-agreement-modal" style="display:none;">
            <p>This plugin will import Sender.Law content as posts on your blog.</p>
            <p>These posts may contain links to <a href="https://sender.law">Sender.Law</a> and other sites that our editorial
...
<?php $banner_url = SENDERLAW_RSS_PI_URL . "app/assets/img/rss-post-importer_280x600.jpg"; ?>
